...
const initializeSocket = (server) => {
    ...
    io.on("connection", (socket) => {
        ...
        socket.on("user_connected", async (connectingUserId) => {
            try {
                if (!connectingUserId) {
                    console.error("❌ Received user_connected but userId is missing!");
                    return;
                }
                ...
                console.log("✅ User added to onlineUsers map. Current Map Size:", onlineUsers.size);
                ...
                console.error("Error in user_connected socket:", error);
            }
        })
